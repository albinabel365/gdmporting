...
define(["require", "exports", "abg2d/abg2d", "asset/asset", "howler/howler", "big-win/big-win", "events/events", "game/game", "game-data/game-data", "gls-comms/gls-comms", "http-connection/http-connection", "input/input", "locale/locale", "particle-effect/particle-effect", "reels/reels", "standard-reels/standard-reels", "TimelineLite", "TimelineMax", "TweenLite", "TweenMax", "util/util"], function (require, exports, abg2d, asset, howler, bigwin, events, game, gamedata, glscomms, httpconnection, input, locale, particleeffect, reels, standardreels, TimelineLite, TimelineMax, TweenLite, TweenMax, util) {
    /**
     * Slot Class
     * @class eef.Slot
    ...
    var Main = (function () {
        ...
        function Main(metaData, partnerAdapter, partnerListener, balanceService) {
            ...
            this.glsRequestor = new glscomms.GLSRequestor(metaData, partnerAdapter.getSessionData(), EEFConfig.GLM_INFO);
            this.glsRequestor.setXMLParserFactory(new EEFResponseXMLParserFactory);
            ...
            var symbolAtlasPath = EEFConfig.CDN_ROOT + "atlas/resources/atlas/symbols/symbols.atlas?appcode=eightyeightfortunes&scale=" + this.scalar + "&resourceversion=" + metaData.getResourceVersion();
            ...
            this.baseBundle = {
                background: new asset.ImageAsset(resourcePath + "images/" + isNt + "background.png?scale=" + this.scalar),
                ...
                flybats: new asset.ImageAsset(assetPath + "atlas/resources/atlas/flybats/flybats.atlas?appcode=eightyeightfortunes&scale=" + this.scalar + "&resourceversion=" + metaData.getResourceVersion()),
                LandingScreen: new asset.ImageAsset(resourcePath + "images/" + isNt + "LandingScreen.jpg?scale=" + this.scalar),
            ...
            this.fuBundle = {
                ...
                minijackpotbanner: new asset.ImageAsset(resourcePath + "images/" + isNt + "minijackpotbanner.png?scale=" + this.scalar),
                minorjackpotbanner: new asset.ImageAsset(resourcePath + "images/" + isNt + "minorjackpotbanner.png?scale=" + this.scalar),
                majorjackpotbanner: new asset.ImageAsset(resourcePath + "images/" + isNt + "majorjackpotbanner.png?scale=" + this.scalar),
                grandjackpotbanner: new asset.ImageAsset(resourcePath + "images/" + isNt + "grandjackpotbanner.png?scale=" + this.scalar),
                coingoldanim: new asset.ImageAsset(assetPath + "atlas/resources/atlas/coingold/coingold.atlas?appcode=eightyeightfortunes&scale=" + this.scalar + "&resourceversion=" + metaData.getResourceVersion()),
                bowlcloseanim: new asset.ImageAsset(assetPath + "atlas/resources/atlas/bowlclose/bowlclose.atlas?appcode=eightyeightfortunes&scale=" + this.scalar + "&resourceversion=" + metaData.getResourceVersion()),
                bowlshakeanim: new asset.ImageAsset(assetPath + "atlas/resources/atlas/bowlshake/bowlshake.atlas?appcode=eightyeightfortunes&scale=" + this.scalar + "&resourceversion=" + metaData.getResourceVersion()),
                bowlexplodeanim: new asset.ImageAsset(assetPath + "atlas/resources/atlas/bowlexplode/bowlexplode.atlas?appcode=eightyeightfortunes&scale=" + this.scalar + "&resourceversion=" + metaData.getResourceVersion())
            };
            this.audioBundle = {
            ...
            this.freeSpinBundle = {
                rightDoor: new asset.ImageAsset(resourcePath + "images/fsdoor_right.jpg?scale=" + this.scalar),
                leftDoor: new asset.ImageAsset(resourcePath + "images/fsdoor_left.jpg?scale=" + this.scalar),
                background: new asset.ImageAsset(resourcePath + "images/fs_background.png?scale=" + this.scalar),
                tally: new asset.ImageAsset(resourcePath + "images/tally.png?scale=" + this.scalar)
            };
            this.animationBundle = {
                h1: new asset.ImageAsset(assetPath + "atlas/resources/atlas/h1/h1.atlas?appcode=eightyeightfortunes&scale=" + this.scalar + "&resourceversion=" + metaData.getResourceVersion()),
                h2: new asset.ImageAsset(assetPath + "atlas/resources/atlas/h2/h2.atlas?appcode=eightyeightfortunes&scale=" + this.scalar + "&resourceversion=" + metaData.getResourceVersion()),
                h3: new asset.ImageAsset(assetPath + "atlas/resources/atlas/h3/h3.atlas?appcode=eightyeightfortunes&scale=" + this.scalar + "&resourceversion=" + metaData.getResourceVersion()),
                h4: new asset.ImageAsset(assetPath + "atlas/resources/atlas/h4/h4.atlas?appcode=eightyeightfortunes&scale=" + this.scalar + "&resourceversion=" + metaData.getResourceVersion()),
                h5: new asset.ImageAsset(assetPath + "atlas/resources/atlas/h5/h5.atlas?appcode=eightyeightfortunes&scale=" + this.scalar + "&resourceversion=" + metaData.getResourceVersion()),
                m1: new asset.ImageAsset(assetPath + "atlas/resources/atlas/m1/m1.atlas?appcode=eightyeightfortunes&scale=" + this.scalar + "&resourceversion=" + metaData.getResourceVersion()),
                m2: new asset.ImageAsset(assetPath + "atlas/resources/atlas/m2/m2.atlas?appcode=eightyeightfortunes&scale=" + this.scalar + "&resourceversion=" + metaData.getResourceVersion()),
                m3: new asset.ImageAsset(assetPath + "atlas/resources/atlas/m3/m3.atlas?appcode=eightyeightfortunes&scale=" + this.scalar + "&resourceversion=" + metaData.getResourceVersion()),
                m4: new asset.ImageAsset(assetPath + "atlas/resources/atlas/m4/m4.atlas?appcode=eightyeightfortunes&scale=" + this.scalar + "&resourceversion=" + metaData.getResourceVersion()),
                m5: new asset.ImageAsset(assetPath + "atlas/resources/atlas/m5/m5.atlas?appcode=eightyeightfortunes&scale=" + this.scalar + "&resourceversion=" + metaData.getResourceVersion()),
                l1: new asset.ImageAsset(assetPath + "atlas/resources/atlas/l1/l1.atlas?appcode=eightyeightfortunes&scale=" + this.scalar + "&resourceversion=" + metaData.getResourceVersion()),
                l2: new asset.ImageAsset(assetPath + "atlas/resources/atlas/l2/l2.atlas?appcode=eightyeightfortunes&scale=" + this.scalar + "&resourceversion=" + metaData.getResourceVersion()),
                l3: new asset.ImageAsset(assetPath + "atlas/resources/atlas/l3/l3.atlas?appcode=eightyeightfortunes&scale=" + this.scalar + "&resourceversion=" + metaData.getResourceVersion()),
                l4: new asset.ImageAsset(assetPath + "atlas/resources/atlas/l4/l4.atlas?appcode=eightyeightfortunes&scale=" + this.scalar + "&resourceversion=" + metaData.getResourceVersion()),
                l5: new asset.ImageAsset(assetPath + "atlas/resources/atlas/l5/l5.atlas?appcode=eightyeightfortunes&scale=" + this.scalar + "&resourceversion=" + metaData.getResourceVersion()),
                wild: new asset.ImageAsset(assetPath + "atlas/resources/atlas/wild/wild.atlas?appcode=eightyeightfortunes&scale=" + this.scalar + "&resourceversion=" + metaData.getResourceVersion()),
                z_bonus: new asset.ImageAsset(assetPath + "atlas/resources/atlas/z_bonus/z_bonus.atlas?appcode=eightyeightfortunes&scale=" + this.scalar + "&resourceversion=" + metaData.getResourceVersion())
            };
            this.bigWinBundle = {
                marquee: new asset.ImageAsset(resourcePath + "images/bigwinmarquee.png?scale=" + this.scalar),
                coins: new asset.ImageAsset(assetPath + "atlas/resources/atlas/coins/coins.atlas?appcode=eightyeightfortunes&scale=" + this.scalar + "&resourceversion=" + metaData.getResourceVersion()),
                glow: new asset.ImageAsset(assetPath + "atlas/resources/atlas/glow/glow.atlas?appcode=eightyeightfortunes&scale=" + this.scalar + "&resourceversion=" + metaData.getResourceVersion())
            };
        ...
        Main.prototype.createUI = function () {
            ...
            this.uiController = UIFactory.create(this.scene, this.background, this.scalar, this.baseBundle, this.fuBundle, this.translator, this.glsRequestor, this.currencyFormatter, this.inputHandler, this.audioController, this.partnerAdapter.getGameDomElement(), this.metaData, this.partnerListener);
        ...
        */
        ...
        Main.prototype.sendingRePlayRequest = function (betController) {
            this.historyData.configure(this.logic, betController, this.glsRequestor);
    ...
    var UIController = (function () {
        ...
        UIController.prototype.enablaAutoPlay = function (enable) {
            ...
            this.setButton.getEvents().add({
                onClick: function (x, y) {
                    if (_this.settingsMenu.getIsAllowed()) {
                        _this.logic.partnerAdapter.logics.view.menuView.showMenu();
                    }
                },
                onClickEnd: function () {
                }
            ...
            this.exthelpButton.getEvents().add({
                onClick: function (x, y) {
                    ...
                    if (_this.logic.partnerAdapter && _this.logic.partnerAdapter.logics.view) {
                        if (_this.logic.partnerAdapter.logics.view.canGoToExternalHelp()) {
            ...
            if (this.canUpdateBalance) {
                ...
                if (this.partnerListener != undefined) {
                    if (this.partnerListener.platformBalanceDisplayEventListener) {
                        ...
                        var openBetFreeBet = 0;
                        if (this.isRealMoney) {
                            if (this.gameData.getCustomData().getOpenBetPayLoadInfo() != undefined && this.gameData.getCustomData().getOpenBetPayLoadInfo()[type]) {
                            ...
                            else if (this.initResponseGameData !== undefined && this.initResponseGameData.getCustomData().getOpenBetPayLoadInfo()[EEFConfig.INIT] != undefined && this.initResponseGameData.getCustomData().getOpenBetPayLoadInfo()[EEFConfig.INIT]) {
        ...
        UIController.prototype.enableUIButtons = function (visible) {
            ...
            //this.autoPlayManager.setVisible(visible);
            this.autoPlayButton.setActive(visible);
            this.betMenu.betChange(visible);
            //this.multiplierMenu.showButton(visible);	
       ...
       */
        ...
        **/
        ...
        UIController.prototype.checkExtHelpBtnEnable = function () {
            if (this.logic.partnerAdapter && this.logic.partnerAdapter.logics.view) {
                ...
                var partner_Old = this.logic.partnerAdapter.logics.view.canGoToExternalHelp;
                if (partner_New != undefined) {
                    ...
                    this.isExernalHelpEnabled = this.logic.partnerAdapter.logics.view.canGoToExternalHelp();
                }
                else {
    ...
    var HelpAndPays = (function () {
         ...
         * @constructor
         */
        function HelpAndPays(translator, currencyFormatter, baseBundle, fuBundle, glsRequestor, element, betMenu, metaData) {
            var _this = this;
            this.translator = translator;
            this.betMenu = betMenu;
            this.currencyFormatter = currencyFormatter;
    ...
    var RecoveryManager = (function () {
        ...
        RecoveryManager.prototype.sendPlayRequest = function () {
            var payloads = [];
            //var payload: glscomms.AnywayWagerPayload = new glscomms.AnywayWagerPayload(this.data.betController.getCurrentBet().getTotalBet());
         ...
         * @private
         * @param {glscomms.PlayResponse} playResponse The response from the server
         */
    ...
    */
    ...
    var HistoryStack = (function () {
        ...
        HistoryStack.prototype.configure = function (logic, betController, glsRequestor) {
            var _this = this;
            this.logic = logic;
    ...
    var Logic = (function () {
        ...
        Logic.prototype.sendWager = function (wager, requestHeaders) {
            this.lastWager = wager;
            this.slot.spin();
            this.glsRequestor.makePlayRequest(this.createPayloads(wager), requestHeaders);
         ...
         * @private
         * @param {glscomms.PlayResponse} response The play response from the server
         */
         ...
         * @private
         * @param {glscomms.EndResponse} response The end response from the server
         */
         ...
         * @returns {glscomms.ICustomGLSPayload[]} The list of payloads to send to the GLS
         */
        Logic.prototype.createPayloads = function (wager) {
            ...
            payloads.push(payload);
            if (this.isHistoryReplay) {
                payloads.push(new glscomms.ReplayRequestPayload(this.historyReplayData.getNextState()));
            }
        ...
        * @param {glscomms.PlayResponse} It Will contain play response.
        */
     ...
     * @extends glscomms.PlayResponseXMLParser
     */
    var EEFPlayResponseXMLParser = (function () {
         ...
         * @returns {glscomms.PlayResponse} Response data for Play request
         */
        EEFPlayResponseXMLParser.prototype.parse = function (xml) {
            //var response: glscomms.PlayResponse = super.parse(xml);
            ...
            if (bgResultData.length > 0) {
                ...
                glscomms.GamePlayDataXMLParser.populateGameData(BGReelData.getBaseGameResult(), bgResultData[0].childNodes[0]);
            }
    ...
    var EEFBaseGameSpinData = (function () {
        ...
        /**
             ...
             * @public
             * @returns {glscomms.PlatformPlayData} returning the Open bet data.
             */
    ...
    */
    ...
    var EEFResponseXMLParserFactory = (function (_super) {
        ...
        /**
         * Construct DBS-specific play response parser
         * @method eef.EEFResponseXMLParserFactory#createPlayParser
         * @public
         * @returns {glscomms.IResponseXMLParser<glscomms.PlayResponse} Response XML parser
         */
    ...
    var EEFInitResponseXMLParser = (function () {
        ...
        EEFInitResponseXMLParser.prototype.parse = function (xml) {
            var platformData = this.parsePlatformData(xml);
            var balanceData = glscomms.BalanceData.parseXML(xml.getElementsByTagName("Balances")[0]);
            var response = new glscomms.InitResponse(platformData, balanceData);
            ...
            this.populateBetConfiguration(gameData, xml.getElementsByTagName("CreditBets")[0], xml.getElementsByTagName("BetMultipliers")[0]);
        ...
        /**
             ...
             * @param {Node} node XML node containing open bet configuration data
             */
        EEFInitResponseXMLParser.prototype.populateOpenBetPayLoad = function (gameData, node) {
            var openBetPayLoad = [];
            var data = { type: "", CASH: "0", FREEBET: "0", BONUS: "0" };
            for (var i = 0; i < node.childNodes.length; i++) {
                var payloadItem = node.childNodes[i], requestType = payloadItem.attributes.getNamedItem("request").value, payloadNode = payloadItem.childNodes[0];
        ...
        * @param {Node} node XML node containing open bet configuration data
        */
        EEFInitResponseXMLParser.prototype.getOpenBetValueByName = function (mapItem, requestType) {
            var data = null;
            for (var i = 0; i < mapItem.childNodes.length; i++) {
                if (mapItem.childNodes[i].nodeName == "key") {
                }
         ...
         */
        EEFInitResponseXMLParser.prototype.populateAwardsData = function (gameData, node) {
            var attributes = node.attributes;
         ...
         */
        EEFInitResponseXMLParser.prototype.populatePaylineData = function (gameData, node) {
            if (node != null) {
                var attributes = node.attributes;
                var nodeChildren = node.childNodes;
         ...
         */
        EEFInitResponseXMLParser.prototype.populateReelGroupData = function (gameData, node) {
            var attributes = node.attributes;
            var nodeChildren = node.childNodes;
    ...
    var UIFactory = (function () {
         ...
         * @param {BaseBundle} baseBundle The base bundle of assets
         * @param {locale.Translator} translator The translator object
         * @param {glscomms.GLSRequestor} glsRequestor The gls requestor object
         * @param {locale.CurrencyFormatter} currencyFormatter The currency formatter
         ...
         */
        UIFactory.create = function (scene, background, scalar, baseBundle, fuBundle, translator, glsRequestor, currencyFormatter, inputHandler, audioController, gameElement, metaData, partnerListener) {
            ...
            var help = new HelpAndPays(translator, currencyFormatter, baseBundle, fuBundle, glsRequestor, gameElement, betSubMenu, metaData);
